...
4. C.M. Sperberg-McQueen and Lou Burnard, [*TEI Lite: Encoding for Interchange: an introduction to the TEI*](https://tei-c.org/release/doc/tei-p5-exemplars/html/tei_lite.doc.html). This is the original generic TEI Tutorial, designed to meet the needs of 90% of the TEI community, 90% of the time.
