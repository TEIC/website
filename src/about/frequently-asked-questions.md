...
customization process, the TEI supports a tool called [Roma](https://roma.tei-c.org), which provides a web
...
Guidelines on [Using the TEI](/release/doc/tei-p5-doc/en/html/USE.html) describes the customization process in more detail. You
