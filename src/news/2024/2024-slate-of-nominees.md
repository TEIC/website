...
Over the past years, I have contributed to the conceptual design, development and implementation of numerous cooperative research projects in the field of digital humanities, employing TEI and X-Technologies (see: [the GAMS
Humanities Asset Management System](http://gams.uni-graz.at]).) Since 2014, I have been a member of the Institute for Documentology and Scholarly Editing (IDE), and since 2015, I have had the honor to serve on the TEI Technical Council with the full support of my department.
