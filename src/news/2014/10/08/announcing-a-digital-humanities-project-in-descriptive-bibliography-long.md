---
title: "Announcing a digital humanities project in descriptive bibliography (long)"
date: "2014-10-08"
author: "theteiadmin"
permalink: "/news/2014/10/08/announcing-a-digital-humanities-project-in-descriptive-bibliography-long/"
tags: ["Other", "Collected Editions", "descriptive bibliography", "Edmond Hoyle"]
---
...
Recently I decided that I wanted to publish the descriptions incrementally on the web before publishing the book. The decision led me to launch an ambitious digital humanities project:  I have started to encode book descriptions in TEI-like XML files. The XML files are transformed both into HTML and into word processing documents. Thus, I can publish incrementally on the web while having all the work available for later print publication. Importantly, each time I create a handful of new descriptions, I run programs to regenerate all the indices and book lists for both the web site and the print version.<br/>

To make sure everything was going to work, I built a web site as a proof of concept, located [here](http://booksongaming.com/hoyle/bibliography/). If you are interested, I would encourage you to visit the site and to comment upon it. Each page has a link at the bottom for feedback which will result in an email to me (and *not* to the list).
...
The [home page](http://booksongaming.com/hoyle/bibliography/) lists:
...
and a number of **Search** tools. Eventually there will be ten items listed under**Separate Works**, three under **Collections** and ten under **Collected Editions**, more when I get into the 19<sup>th</sup> century. You can click on titles under each category to navigate to lists of books and then to book descriptions.
...
* **Title **(and similarly** Half Title **and **Section Title**) is a quasi-facsimile transcription of the title page. Color, italics, small caps, and black letter are reproduced, although you need the right font on your computer to see the black letter. See [this](http://booksongaming.com/hoyle/bibliography/books/games.2.xml) description and note whether “Whist | Quadrille | Piquet” appear properly.
...
* Should any included items be omitted? I worry that material may overwhelm once the later editions start to include more material. Consider this [book](http://booksongaming.com/hoyle/bibliography/books/games.2.xml) covering only five games and a more complex[book](http://booksongaming.com/hoyle/bibliography/books/jones.2.xml) that appeared twenty years later.
