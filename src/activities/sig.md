...
* [AI Tools for TEI](/activities/sig/ai-tools-for-tei). Convener: Chris Ruotolo.  [Join mailing list](https://lists.psu.edu/cgi-bin/wa?SUBED1=TEI-AI-SIG&A=1); [list archive](https://lists.psu.edu/cgi-bin/wa?A0=TEI-AI-SIG)
* [Computable Text and Media SIG](/activities/sig/computable). Conveners: Torsten Roeder and Lauren Liebe.  [Join mailing list](https://lists.psu.edu/cgi-bin/wa?SUBED1=TEI-COMPUTABLE-SIG&A=1); [list archive](https://lists.psu.edu/cgi-bin/wa?A0=TEI-COMPUTABLE-SIG)
...
* Graph Technologies. Conveners: Stefan Armbruster, Sebastian Enns, Andreas Kuczera, and Iian Neill. [Visit Wiki](https://wiki.tei-c.org/index.php/SIG:GraphTechnologies).
...
* [Music](/activities/sig/music/ "Music"). Conveners: Raffaele Viglianti and Torsten Roeder.
...
* [Tools](/activities/sig/tools/ "Tools"). Convener: Serge Heiden. [visit Wiki](https://wiki.tei-c.org/index.php/SIG:Tools "visit Wiki").
