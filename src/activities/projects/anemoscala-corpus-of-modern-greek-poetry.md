...
**Implementation description**: TEI All (instead of [TEI Lite](https://tei-c.org/release/doc/tei-p5-exemplars/html/tei_lite.doc.html) which was our original intention), but we are working on a slightly modified DTD which is TEI-conformant.
