...
In post\-meeting discussion, consensus was that RELAX NG XML syntax does need to
 ...
 DS explained that this item grew out of [an observation on TEI\-L from Romain Roure](https://lists.psu.edu/cgi-bin/wa?A2=TEI-L;49b35df7.0806&S=) that the tei\_all.xsd schema in
