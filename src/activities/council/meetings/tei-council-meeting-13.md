...
In post\-meeting discussion, consensus was that RELAX NG XML syntax does need to
 ...
 DS explained that this item grew out of [an observation on TEI\-L from Romain Roure](https://lists.psu.edu/cgi-bin/wa?A2=ind0806&L=TEI-L&T=0&F=&S=&P=59) that the tei\_all.xsd schema in
...
SR will be asked to report back on the severity
 ...
 on TEI\-PB [was: `https://listserv.brown.edu/?A1=ind0805&L=TEI-PB`] from 
 Murray McGillivray assessing the strengths and
